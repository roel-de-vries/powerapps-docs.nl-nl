...
* **Signalen** retourneren informatie over de omgeving. Bijvoorbeeld: **[Location](functions/signals.md)** retourneert de huidige GPS-coördinaten van het apparaat. Signalen hebben geen parameters of neveneffecten.
* **Opsommingen** retourneren een vooraf gedefinieerde constante waarde. Bijvoorbeeld: **[Color](functions/function-colors.md)** is een opsomming met vooraf gedefinieerde waarden voor **Color.Red**, **Color.Blue**, enzovoort.  Algemene opsommingen zijn hier opgenomen. Functiespecifieke opsommingen worden beschreven bij de functie zelf.
...
**[Acos](functions/function-trig.md)**: retourneert de arccosinus van een getal in radialen.

**[Acot](functions/function-trig.md)**: retourneert de boogcotangens van een getal in radialen.
...
**[And](functions/function-logicals.md)**: Booleaanse logica EN.  Retourneert **waar** als alle argumenten **waar** zijn.  U kunt ook de operator [**&&** gebruiken](functions/operators.md).
...
**[Asin](functions/function-trig.md)**: retourneert de arcsinus van een getal in radialen.
...
**[Average](functions/function-aggregates.md)**: berekent het gemiddelde van een tabelexpressie of een set argumenten.

## <a name="b"></a>B
**[Back](functions/function-navigate.md)**: geeft het vorige scherm weer.  

**[Blank](functions/function-isblank-isempty.md)**: retourneert een *lege* waarde die kan worden gebruikt om een NULL-waarde in een gegevensbron in te voegen.

## <a name="c"></a>C
**[Calendar](functions/function-clock-calendar.md)**: haalt informatie op over de agenda voor de huidige landinstelling.
...
**[Color](functions/function-colors.md)**: stelt een eigenschap in op een ingebouwde kleurwaarde.
...
**[Compass](functions/signals.md)**: retourneert de koptekst van uw kompas.
...
**[Count](functions/function-table-counts.md)**: telt tabelrecords die getallen bevatten.
...
**[CountA](functions/function-table-counts.md)**: telt tabelrecords die niet [leeg](functions/function-isblank-isempty.md) zijn.

**[CountIf](functions/function-table-counts.md)**: telt tabelrecords die voldoen aan een voorwaarde.  
...
**[Date](functions/function-date-time.md)**: retourneert een datum/tijd-waarde op basis van de waarden voor **Jaar**, **Maand** en **Dag**.  
...
**[Day](functions/function-datetime-parts.md)**: haalt het daggedeelte op uit een datum/tijd-waarde.  
...
**[Download](functions/function-param.md)**: downloadt een bestand van internet naar het lokale apparaat.
...
**[Enable](functions/function-enable-disable.md)**: schakelt een signaal in, zoals **[Location](functions/signals.md)** voor het lezen van de GPS.

**[EndsWith](functions/function-startswith.md)** – Controleert of een tekenreeks eindigt met een andere tekenreeks.

**[Errors](functions/function-errors.md)**: biedt foutinformatie voor eerdere wijzigingen in een gegevensbron.

**[EncodeUrl](functions/function-encode-decode.md)**: codeert speciale tekens met behulp van URL-codering.

**[Exit](functions/function-exit.md)**: sluit de app die op dat moment wordt uitgevoerd.

**[Exp](functions/function-numericals.md)**: retourneert *e* tot een macht verheven.

## <a name="f"></a>F
**[Filter](functions/function-filter-lookup.md)**: retourneert een gefilterde tabel op basis van een of meer criteria.
...
**[First](functions/function-first-last.md)**: retourneert de eerste record van een tabel.
...
**[Hour](functions/function-datetime-parts.md)**: retourneert het uurgedeelte van een datum/tijd-waarde.
...
**[IsToday](functions/function-now-today-istoday.md)**: controleert of een datum/tijd-waarde vandaag is.

## <a name="l"></a>L
**[Language](functions/function-language.md)**: retourneert de taalcode voor de huidige gebruiker.

**[Last](functions/function-first-last.md)**: retourneert de laatste record van een tabel.
...
**[Left](functions/function-left-mid-right.md)**: retourneert het meest linkse gedeelte van een tekenreeks.
...
**[Lower](functions/function-lower-upper-proper.md)**: converteert letters in een tekenreeks met tekst naar kleine letters.
...
**[Minute](functions/function-datetime-parts.md)**: haalt het minuutgedeelte op uit een datum/tijd-waarde.  

**[Mod](functions/function-mod.md)**: retourneert het restgetal nadat een deeltal is gedeeld door een deler.

**[Month](functions/function-datetime-parts.md)**: haalt het maandgedeelte op uit een datum/tijd-waarde.

## <a name="n"></a>N
**[Navigate](functions/function-navigate.md)**: wijzigt welke scherm wordt weergegeven.

**[NewForm](functions/function-form.md)**: stelt een besturingselement voor formulieren opnieuw in om een item te maken.

**[Not](functions/function-logicals.md)**: Booleaanse logica NIET.  Retourneert **waar** als het bijbehorende argument **onwaar** is, en retourneert **onwaar** als het bijbehorende argument **waar**.  U kunt ook de operator [**!** gebruiken](functions/operators.md).

**[Now](functions/function-now-today-istoday.md)**: retourneert de huidige datum/tijd-waarde.

## <a name="o"></a>O
**[Or](functions/function-logicals.md)**: Booleaanse logica OF.  Retourneert **waar** als alle bijbehorende argumenten **waar** zijn.  U kunt ook de operator [**||** gebruiken](functions/operators.md).

## <a name="p"></a>P
**[Param](functions/function-param.md)**: biedt toegang tot parameters die zijn doorgegeven aan de app toen de gebruiker deze opende.

**[Parent](functions/operators.md#parent-operator)**: biedt toegang tot de eigenschappen van een containerbesturingselement.
...
**[PlainText](functions/function-encode-decode.md)**: verwijdert HTML- en XML-tags uit een tekenreeks.

**[Power](functions/function-numericals.md)**: retourneert een getal dat tot een macht is verheven.  U kunt ook de operator [**^** gebruiken](functions/operators.md).

**[Proper](functions/function-lower-upper-proper.md)**: converteert de eerste letter van elk woord in een tekenreeks naar hoofdletters, en de rest naar kleine letters.

## <a name="r"></a>R
**[Radians](functions/function-trig.md)**: converteert graden naar radialen.

**[Rand](functions/function-rand.md)**: retourneert een pseudo-willekeurig getal.

**[Refresh](functions/function-refresh.md)**: vernieuwt de records van een gegevensbron.

**[Remove](functions/function-remove-removeif.md)**: verwijder een of meer specifieke records uit een gegevensbron.
...
**[Replace](functions/function-replace-substitute.md)**: vervangt een gedeelte van een tekenreeks door een andere tekenreeks, op basis van de startpositie van de tekenreeks.

**[Reset](functions/function-reset.md)**: hiermee stelt u een invoer-besturingselement in op de standaardwaarde en worden gebruikerswijzigingen genegeerd.
...
**[Revert](functions/function-revert.md)**: laadt fouten in de records van een gegevensbron opnieuw en wist ze.
...
**[Right](functions/function-left-mid-right.md)**: retourneert het meest rechtse gedeelte van een tekenreeks.
...
**[RoundUp](functions/function-round.md)**: rondt af naar het kleinste volgende getal.

## <a name="s"></a>S
**[SaveData](functions/function-savedata-loaddata.md)**: slaat een verzameling op in PowerApps-privéopslag.

**[Search](functions/function-filter-lookup.md)**: zoekt records in een tabel met een tekenreeks in een van de kolommen.  
...
**[Sort](functions/function-sort.md)**: retourneert een gesorteerde tabel op basis van een formule.
...
**[Switch](functions/function-if.md)**: komt overeen met een set waarden en evalueert vervolgens een bijbehorende formule.

## <a name="t"></a>T
**[Table](functions/function-table.md)**: maakt een tijdelijke tabel.  

**[Tan](functions/function-trig.md)**: retourneert de tangens van een hoek aangeduid in radialen.

**[Text](functions/function-text.md)**: maakt een getal op als een tekenreeks om weer te geven.
...
**[Time](functions/function-date-time.md)**: retourneert een datum/tijd-waarde, op basis van de waarden voor **uur**, **minuut** en **seconde**.  
...
**[TrimEnds](functions/function-trim.md)**: verwijdert alleen extra spaties bij de uiteinden van een tekenreeks.

## <a name="u"></a>U
**[Ungroup](functions/function-groupby.md)**: verwijdert een groepering.
...
**[Upper](functions/function-lower-upper-proper.md)**: converteert letters in een tekenreeks met tekst naar hoofdletters.

**[User](functions/function-user.md)**: retourneert informatie over de huidige gebruiker.

## <a name="v"></a>V
**[Validate](functions/function-validate.md)**: controleert of de waarde van één kolom of een volledige gegevensrecord geldig is voor een gegevensbron.

**[Value](functions/function-value.md)**: converteert een tekenreeks naar een getal.
...
## <a name="w"></a>W
**[Weekday](functions/function-datetime-parts.md)**: haalt het weekgedeelte op uit een datum/tijd-waarde.

## <a name="y"></a>Y
**[Year](functions/function-datetime-parts.md)**: haalt het jaargedeelte op uit een datum/tijd-waarde.  
