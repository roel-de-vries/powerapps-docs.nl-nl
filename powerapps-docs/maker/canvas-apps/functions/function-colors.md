...
De opsomming **Color** is een eenvoudige manier om de kleuren te vinden die zijn gedefinieerd met de Cascading Style Sheets (CSS) in HTML.  **Color.Red** retourneert bijvoorbeeld een zuivere rode kleur.  U vind de lijst met deze kleuren aan het einde van dit artikel.   

De functie **ColorValue** retourneert een kleur op basis van een CSS-kleurenreeks.  U kunt zowel namen van CSS-kleuren zoals "RosyBrown" en hexadecimale waarden zoals "#bc8f8f" gebruiken.

De functie **RGBA** retourneert een kleur op basis van de rode, groene en blauwe kleurcomponenten.  De functie omvat ook een Alpha-component dat wordt gebruikt voor het mengen van kleuren van objecten die gelaagd boven op elkaar liggen.  Alpha varieert van 0 of 0% (volledig transparant en doorzichtig) tot 1 of 100% (volledig ondoorzichtig en onderliggende lagen worden volledig geblokkeerd).
...
* *ColorName* - vereist.  De kleurnaam uit een Cascading Style Sheet (CSS).  Zie de onderstaande lijst voor mogelijke opsommingswaarden.

**ColorValue**( *CSSColor* )

* *CSSColor* - vereist.  Een kleurdefinitie uit een Cascading Style Sheet (CSS).  U kunt zowel namen van kleuren zoals "OliveDrab" en hexadecimale waarden zoals "#6b8e23" gebruiken.  

**RGBA**( *Red*, *Green*, *Blue*, *Alpha* )

* *Red*, *Green*, *Blue* - vereist.  Waarden van de kleurcomponenten, variërend van 0 (geen verzadiging) tot 255 (volledige verzadiging).
* *Alpha* - vereist.  Alpha-component, variërend van 0 (volledig doorzichtig) tot 1 (volledig ondoorzichtig).  U kunt ook een percentage gebruiken tussen 0 en 100%.

**ColorFade**( *Kleur*, *FadeAmount* )

* *Color* - vereist.  Een kleurwaarde zoals **Color.Red** of de uitvoer van **ColorValue** of **RGBA**.
