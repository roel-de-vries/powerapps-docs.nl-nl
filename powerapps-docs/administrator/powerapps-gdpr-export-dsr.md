...
* Website-toegang: [PowerApps](https://web.powerapps.com), [PowerApps-beheercentrum](https://admin.powerapps.com/) en [Office 365 Service Trust Portal](https://servicetrust.microsoft.com/)
...
> *** Een beheerder heeft alleen toegang tot deze resources vanuit [PowerApps](https://web.powerapps.com) als de eigenaar van de resource hem of haar expliciet toegang heeft verleend. Als er geen toegang aan de beheerder is verleend, moet hij of zij gebruikmaken van de [PowerApps-cmdlets voor PowerApps-beheerders](https://go.microsoft.com/fwlink/?linkid=871804).
