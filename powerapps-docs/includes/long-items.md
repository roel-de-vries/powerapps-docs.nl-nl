[**Items**](../maker/canvas-apps/controls/properties-core.md): de gegevensbron die wordt weergegeven in een besturingselement zoals een galerie, een lijst of een grafiek.
